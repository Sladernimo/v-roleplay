...
function loadCommands() {
	let tempCommands = {
		...
		business: [
			...
			new CommandData("bizpaintball", setBusinessEntranceLabelToDealershipCommand, "", getStaffFlagValue("None"), true, true, "Sets the business to a paintball arena"),
		],
		chat: [
		...
		staff: [
			...
			new CommandData("sethealth", setPlayerHealthCommand, "<player name/id> <health", getStaffFlagValue("BasicModeration"), true, true, "Sets a player's health"),
			new CommandData("setarmour", setPlayerArmourCommand, "<player name/id> <armour>", getStaffFlagValue("BasicModeration"), true, true, "Sets a player's armour"),
