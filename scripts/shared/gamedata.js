...
// Not used yet, needs data and script converted for it
class InteriorData {
	constructor(name, data) {
		this.name = name;
		this.position = (typeof data.position != "undefined") ? data.position : toVector3(0.0, 0.0, 0.0);
		this.rotation = (typeof data.rotation != "undefined") ? data.rotation : 0.0;
		this.scene = (typeof data.scene != "undefined") ? data.scene : "";
...
let gameData = {
	...
	weather: {
		...
		[V_GAME_GTA_IV]: [ // GTA IV
			new WeatherData(0, "Extra Sunny", false),
			new WeatherData(1, "Sunny", false),
			new WeatherData(2, "Sunny/Windy", false),
			new WeatherData(3, "Cloudy", false),
			new WeatherData(4, "Rain", false),
			new WeatherData(5, "Light Rain", false),
			new WeatherData(6, "Foggy", false),
			new WeatherData(7, "Thunderstorm", false),
			new WeatherData(8, "Extra Sunny", false),
	...
	vehicles: {
		...
		[V_GAME_GTA_IV]: [ // GTA IV
			[1264341792, "Admiral", 8000],
			[1560980623, "Airtug", -1],
			[1171614426, "Ambulance", -1],
			[-1041692462, "Banshee", 125000],
			[2053223216, "Benson"],
			[850991848, "Biff"],
			[-344943009, "Blista"],
			[1075851868, "Bobcat"],
			...
			[-1346687836, "Burrito"],
			[-907477130, "Burrito 2"],
			[-713569950, "Bus", 100000],
			[1884962369, "Cabby"],
			[2006918058, "Cavalcade", 75000],
			[-67282078, "Chavos"],
			[-2030171296, "Cognoscenti", 75000],
			[1063483177, "Comet"],
			[108773431, "Coquette", 125000],
			[162883121, "DF8"],
			...
			[-276900515, "Esperanto"],
			[-2119578145, "Faction"],
			[1127131465, "FIB Car", -1],
			[-1097828879, "Feltzer"],
			[974744810, "Feroci"],
			[1026055242, "Airport Feroci", -1],
			[1938952078, "Firetruck", -1],
			[1353720154, "Flatbed"],
			[627033353, "Fortune"],
			[1491375716, "Forklift"],
			[2016857647, "Futo"],
			...
			[884422927, "Habanero"],
			[-341892653, "Hakumai"],
			[486987393, "Huntley", 40000],
			[418536135, "Infernus", 125000],
			[-1289722222, "Ingot"],
			[886934177, "Intruder"],
			[1269098716, "Landstalker", 40000],
			[-37030056, "Lokus"],
			[-2124201592, "Manana"],
			[1304597482, "Marbella"],
			[-1260881538, "Merit"],
			...
			[583100975, "Mr. Tasty"],
			[904750859, "Mule"],
			[148777611, "Noose Patrol Car", -1],
			[1911513875, "Noose Stockade", -1],
			[1348744438, "Oracle"],
			[569305213, "Packer"],
			[-808457413, "Patriot", 45000],
			[-2077743597, "Perennial"],
			[-1590284256, "Airport Perennial", -1],
			[1830407356, "Peyote"],
			[-2137348917, "Phantom"],
			[131140572, "Pinnacle"],
			[1376298265, "PMP-600"],
			[2046537925, "Police Cruiser", -1],
			[-1627000575, "Police Patrol", -1],
			[-350085182, "Police Patriot", -1],
			[-119658072, "Pony"],
			[-1883869285, "Premier"],
			[-1962071130, "Presidente", 65000],
			[-1150599089, "Primo"],
			[-1900572838, "Police Stockade", -1],
			[1390084576, "Rancher"],
			[83136452, "Rebla"],
			[-845979911, "Reply"],
			[627094268, "Romero"],
			...
			[-956048545, "Taxi"],
			[1208856469, "Taxi 2"],
			[1917016601, "Trashmaster", -1],
			[-1896659641, "Turismo", 125000],
			[1534326199, "Uranus"],
			[-825837129, "Vigero"],
			[-1758379524, "Vigero 2"],
			[-583281407, "Vincent"],
			...
			[788045382, "Sanchez"],
			[-570033273, "Zombie"],
			[837858166, "Annihilator", -1],
			[-1660661558, "Maverick"],
			[353883353, "Police Maverick", -1],
			...
			[1064455782, "Tuga"],
			[290013743, "Tropic"],
			[-960289747, "Cablecar", -1],
			[800869680, "Subway", -1],
			[-1953988645, "El Train", -1],
		],
		[V_GAME_MAFIA_ONE]: [   // Mafia 1
			...
			["cordca00.i3d", "Orange Thor 812 Cabriolet"],
			["cordca01.i3d", "Black Thor 812 Cabriolet"],
	...
	animations: {
		...
		[V_GAME_MAFIA_ONE]: [ // Mafia: The City of Lost Heaven
			...
			new AnimationData("piss", { animId: "chcaniloop.i3d", infiniteLoop: true }),
			...
			new AnimationData("tablesit1left", { animId: "x sed za stolem_A.i3d", infiniteLoop: true, moveType: V_ANIMMOVE_LEFT }),
			new AnimationData("tablesit2left", { animId: "x sed za stolem_B.i3d", infiniteLoop: true, moveType: V_ANIMMOVE_LEFT }),
			new AnimationData("tablesit1right", { animId: "x sed za stolem_A.i3d", infiniteLoop: true, moveType: V_ANIMMOVE_RIGHT }),
			new AnimationData("tablesit2right", { animId: "x sed za stolem_B.i3d", infiniteLoop: true, moveType: V_ANIMMOVE_RIGHT }),
			new AnimationData("tablesit1front", { animId: "x sed za stolem_A.i3d", infiniteLoop: true, moveType: V_ANIMMOVE_FORWARD }),
	...
	defaultBusinessItems: {
		[V_GAME_GTA_III]: { // GTA III
			...
			Bar: [
				["Bottle of Vodka", 20, 2],
				["Bottle of Whiskey", 20, 2],
				["Bottle of Soda", 20, 2],
				["Bottle of Wine", 20, 2],
				["Bottle of Bourbon", 20, 2],
				["Shot of Bourbon", 20, 2],
				["Shot of Vodka", 20, 2],
				["Shot of Whiskey", 20, 2],
				["Glass of Wine", 20, 2],
			],
			Club: [
				["Bottle of Vodka", 20, 2],
			...
			Chicken: [
				["Bucket of Chicken", 20, 2],
				["Chicken Tenders Meal", 20, 2],
				["Large Fries", 20, 2],
				["Small Fries", 20, 2],
				["Bottle of Soda", 20, 2],
			],
			Burger: [
				["Bacon Cheeseburger", 20, 2],
				["Double Cheeseburger", 20, 2],
				["Big Boy Burger", 20, 2],
				["Large Fries", 20, 2],
				["Small Fries", 20, 2],
				["Bottle of Soda", 20, 2],
			...
			Italian: [
				...
				["Arancini", 20, 2],
				["Lasagne", 20, 2],
				["Chicken Alfredo", 20, 2],
				["Fettucine Alfredo", 20, 2],
				["Chicken Parmigiana", 20, 2],
				["Chicken Carbonara", 20, 2],
				["Sausage Rigatoni", 20, 2],
				["Chicken Salad", 20, 2],
				["Caesar Salad", 20, 2],
			],
			Mexican: [
				["Crunchy Taco", 20, 2],
				["Beaf and Bean Burrito", 20, 2],
				["Burrito Supreme", 20, 2],
				["Cheesy Nachos", 20, 2],
				["Nacho Supreme", 20, 2],
				["Bottle of Soda", 20, 2],
			],
			...
			CoffeeDonutShop: [
				...
				["Frosted Donut", 20, 2],
				["Jelly Donut", 20, 2],
				["Cream-filled Donut", 20, 2],
				["Apple Fritter", 20, 2],
				["Pumpkin Spice Latte", 20, 2],
				["Mocha Latte", 20, 2],
				["Iced Coffee", 20, 2],
				["Large Coffee", 20, 2],
				["Small Coffee", 20, 2],
			...
			VehicleRepairShop: [
				...
				["Vehicle Primary Colour Kit", 20, 2],
				["Vehicle Secondary Colour Kit", 20, 2],
			],
		},
		[V_GAME_GTA_VC]: { // GTA VC
			ClothingStore: [
			...
			IllegalGunStore: [
				...
				["Ruger Ammo", 20, 2],
				["M4 Ammo", 20, 2],
				["Sniper Rifle Ammo", 20, 2],
				["Laser Sniper Ammo", 20, 2],
			],
			GasStation: [
				["Bottle of Soda", 20, 2],
				["Can of Soda", 20, 2],
		...
		[V_GAME_GTA_SA]: { // GTA SA
			...
			LegalGunStore: [
				...
				["Country Rifle", 20, 2],
				["9mm Ammo", 20, 2],
				["Desert Eagle Ammo", 20, 2],
				["Shotgun Ammo", 20, 2],
				["Country Rifle Ammo", 20, 2],
			],
			IllegalGunStore: [
				["Micro SMG/Uzi", 20, 2],
				["MP5", 20, 2],
				...
				["Combat Shotgun", 20, 2],
				["Sniper Rifle", 20, 2],
				["Micro SMG/Uzi Ammo", 20, 2],
				["MP5 Ammo", 20, 2],
				["Tec-9 Ammo", 20, 2],
				["AK-47 Ammo", 20, 2],
				["M4 Ammo", 20, 2],
				["Combat Shotgun Ammo", 20, 2],
				["Sniper Rifle Ammo", 20, 2],
			],
			SexShop: [
				["Purple Dildo", 20, 2],
		...
		[V_GAME_GTA_IV]: { // GTA IV
			...
			IllegalGunStore: [
				...
				["AK-47", 20, 2],
				["M4", 20, 2],
				["Beretta Shotgun", 20, 2],
				["Sniper Rifle", 20, 2],
				["MP5 Ammo", 20, 2],
				["Micro Uzi Ammo", 20, 2],
				["AK-47 Ammo", 20, 2],
				["M4 Ammo", 20, 2],
				["Beretta Shotgun Ammo", 20, 2],
				["Sniper Rifle Ammo", 20, 2],
			],
			GasStation: [
				["Bottle of Soda", 20, 2],
		...
		[V_GAME_MAFIA_ONE]: { // Mafia 1
			...
			LegalGunStore: [
				...
				["Knuckleduster", 20, 2],
				["Knife", 20, 2],
				["S&W Model 10 M&P", 20, 2],
				["S&W Model 27 Magnum", 20, 2],
				["Colt 1911", 20, 2],
				["Shotgun", 20, 2],
				["Sawed-off Shotgun", 20, 2],
				["Thompson 1928", 20, 2],
				["S&W Model 10 Ammo", 20, 2],
				["S&W Magnum Ammo", 20, 2],
				["Colt 1911 Ammo", 20, 2],
				["Pump-action Shotgun Ammo", 20, 2],
				["Sawed-off Shotgun Ammo", 20, 2],
				["Thompson 1928 Ammo", 20, 2],
			],
			IllegalGunStore: [
			],
			SexShop: [
	...
	interiors: {
		[V_GAME_GTA_III]: {
			Apartment1: [toVector3(891.87, -308.28, 8.72), 0, false, "", "", false],
			JailCell: [toVector3(328.40, -1093.31, 25.98), 0, false, "", "", false],
			Church: [toVector3(13.87, -1122.43, 26.12), 0, false, "", "", false],
			Mansion: [toVector3(1461.00, -173.87, 55.78), 0, false, "", "", false],
			SmallGarage: [toVector3(-420.69, 289.86, 62.96), 0, false, "", "", false],
			JoeyGarage: [toVector3(1189.40, -867.69, 15.18), 0, false, "", "", false],
			Warehouse1: [toVector3(1497.46, -680.18, 12.14), 0, false, "", "", false],
			Warehouse2: [toVector3(1131.44, -1113.07, 11.86), 0, false, "", "", false],
		},
		[V_GAME_GTA_VC]: { // GTA VC
			Mall: [toVector3(379.62, 1007.00, 19.22), 4, false, "", "", false],
			MalibuClub: [toVector3(489.83, -76.49, 11.48), 17, false, "", "", false],
			PoliceStation: [toVector3(396.38, -472.96, 12.34), 12, false, "", "", false],
			Apartment: [toVector3(26.67, -1328.89, 13.00), 11, false, "", "", false],
			HotelLobby: [toVector3(228.53, -1277.12, 12.07), 1, false, "", "", false],
			BikerBar: [toVector3(-597.41, 651.84, 11.30), 11, false, "", "", false],
			Mansion: [toVector3(-379.14, -551.65, 19.32), 2, false, "", "", false],
			GunRange: [toVector3(-667.79, 1217.51, 11.10), 10, false, "", "", false],
			Bank: [toVector3(-894.52, -341.16, 13.45), 3, false, "", "", false],
			StripClub: [toVector3(97.53, -1472.06, 10.43), 5, false, "", "", false],
			RosenbergOffice: [toVector3(137.29, -1370.20, 13.18), 6, false, "", "", false],
			Arena: [toVector3(-1080.49, 1331.16, 13.91), 15, false, "", "", false],
			GhettoShack: [toVector3(-962.74, 146.96, 9.40), 12, false, "", "", false],
			HotelRoom: [toVector3(226.47, -1274.98, 19.271), 2, false, "", "", false],
			ConcertHall: [toVector3(-925.417, 1053.4, 13.2005), 8, false, "", "", false],
			RecordingStudio: [toVector3(-879.767, 1156.88, 17.8115), 9, false, "", "", false],
			PrintWorks: [toVector3(-1064.98, -279.093, 12.0882), 18, false, "", "", false],
			GasStation: [toVector3(447.26, 789.09, 12.95), 0, false, "", "", false],
			BusinessOffices: [toVector3(-551.70, 788.04, 97.51), 0, false, "", "", false],
			BusinessOfficeLobby: [toVector3(-573.64, 794.53, 22.88), 0, false, "", "", false],
		},

		[V_GAME_GTA_SA]: { // GTA SA
			LSPD: [toVector3(247.113, 62.929, 1003.64), 2, false, "", "", false],
			LVPD: [toVector3(288.82, 167.39, 1007.17), 3, false, "", "", false],
			SFPD: [toVector3(246.40, 110.84, 1003.22), 10, false, "", "", false],
			ReeceBarberShop: [toVector3(411.62, -21.43, 1001.80), 2, false, "", "", false],
			FourDragons: [toVector3(2016.26, 1017.77, 996.87), 10, false, "", "", false],
			Caligula: [toVector3(2233.8, 1712.23, 1011.76), 1, false, "", "", false],
			GenericCasino: [toVector3(1118.88, -10.27, 1002.08), 12, false, "", "", false],
			CluckinBell: [toVector3(365.71, -9.88, 1001.85), 9, false, "", "", false],
			PizzaStack: [toVector3(372.35, -131.65, 1001.49), 5, false, "", "", false],
			BurgerShot: [toVector3(375.96, -65.81, 1001.50), 10, false, "", "", false],
			TattooParlor: [toVector3(-203.07, -24.16, 1002.27), 16, false, "", "", false],
			Bank: [toVector3(2305.14, -16.274, 26.74), 1, false, "", "", false],
			Gas1: [toVector3(-25.96, -187.67, 1003.54), 17, false, "", "", false],
			Gas2: [toVector3(6.09, -29.27, 1003.54), 10, false, "", "", false],
			Gas3: [toVector3(-30.94, -89.60, 1003.54), 18, false, "", "", false],
			Gas4: [toVector3(-25.13, -139.06, 1003.54), 16, false, "", "", false],
			Gas5: [toVector3(-27.31, -29.27, 1003.54), 4, false, "", "", false],
			Gas6: [toVector3(-26.69, -55.71, 1003.54), 6, false, "", "", false],
			Shamal: [toVector3(2.38, 33.10, 1199.84), 1, false, "", "", false],
			Andromeda: [toVector3(315.85, 1024.49, 1949.79), 9, false, "", "", false],
			AirportTickets: [toVector3(-1827.14, 7.20, 1061.14), 14, false, "", "", false],
			AirportBaggage: [toVector3(-1855.56, 41.26, 1061.14), 14, false, "", "", false],
			Ammu1: [toVector3(286.14, -40.64, 1001.56), 1, false, "", "", false],
			Ammu2: [toVector3(286.80, -82.54, 1001.53), 4, false, "", "", false],
			Ammu3: [toVector3(296.91, -108.07, 1001.56), 6, false, "", "", false],
			Ammu4: [toVector3(314.82, -141.43, 999.66), 7, false, "", "", false],
			Ammu5: [toVector3(316.52, -167.70, 999.66), 6, false, "", "", false],
			AmmuBooth: [toVector3(302.29, -143.13, 1004.06), 7, false, "", "", false],
			AmmuRange: [toVector3(280.79, -135.20, 1004.06), 7, false, "", "", false],
			House1: [toVector3(235.51, 1189.17, 1080.34), 3, false, "", "", false],
			House2: [toVector3(225.76, 1240.00, 1082.15), 2, false, "", "", false],
			House3: [toVector3(223.04, 1289.26, 1082.20), 1, false, "", "", false],
			House4: [toVector3(225.63, 1022.48, 1084.07), 7, false, "", "", false],
			House5: [toVector3(295.14, 1474.47, 1080.52), 15, false, "", "", false],
			House6: [toVector3(328.49, 1480.59, 1084.45), 15, false, "", "", false],
			House7: [toVector3(385.80, 1471.77, 1080.21), 15, false, "", "", false],
			Atrium: [toVector3(1726.18, -1641.00, 20.23), 18, false, "", "", false],
			CrackPalace: [toVector3(2, 567.52, -1294.59, 1063.25), 2, false, "", "", false],
			BloodbowlStadium: [toVector3(-1394.20, 987.62, 1023.96), 15, false, "", "", false],
			BurningDesireHouse: [toVector3(2338.32, -1180.61, 1027.98), 5, false, "", "", false],
			FurhbergerHouse: [toVector3(2807.63, -1170.15, 1025.57), 8, false, "", "", false],
			DillimoreGas: [toVector3(664.19, -570.73, 16.34), 0, false, "", "", false],
			DonutShop: [toVector3(377.19, -192.90, 1000.64), 17, false, "", "", false],
			Airport: [toVector3(-1830.81, 16.83, 1061.14), 14, false, "", "", false],
			JeffersonMotel: [toVector3(2220.26, -1, 148.01, 1025.80), 15, false, "", "", false],
			KickstartStadium: [toVector3(-1410.72, 1, 591.16, 1052.53), 14, false, "", "", false],
			LibertyCity: [toVector3(-750.80, 491.00, 1371.70), 1, false, "", "", false],
			LSXBaggageReclaim: [toVector3(-1870.80, 59.81, 1056.25), 14, false, "", "", false],
			JizzyClub: [toVector3(-2637.69, 1404.24, 906.46), 3, false, "", "", false],
			RCBattlefield: [toVector3(-1079.99, 1061.58, 1343.04), 10, false, "", "", false],
			RyderHouse: [toVector3(2451.77, -1699.80, 1013.51), 2, false, "", "", false],
			SFGarage: [toVector3(-2042.42, 178.59, 28.84), 1, false, "", "", false],
			SweetHouse: [toVector3(2535.83, -1, 674.32, 1015.50), 1, false, "", "", false],
			KatieHouse: [toVector3(267.22, 304.71, 999.14), 2, false, "", "", false],
			HelenaHouse: [toVector3(292.44, 308.77, 999.14), 3, false, "", "", false],
			WelcomePump: [toVector3(681.66, -453.32, -25.61), 1, false, "", "", false],
			WoozieApartment: [toVector3(-2158.72, 641.29, 1052.38), 1, false, "", "", false],
			EightTrackStadium: [toVector3(-1395.96, -208.20, 1051.17), 7, false, "", "", false],
			DirtBikeStadium: [toVector3(-1424.93, -664.59, 1059.86), 4, false, "", "", false],
			CrackDen: [toVector3(75.0475, 1094.6, 18.7597), 5, false, "", "", false],
			MotelRoom: [toVector3(2251.85, -1138.16, 1050.63), 9, false, "", "", false],
			HashburyHouse: [toVector3(2260.76, -1210.45, 1049.02), 10, false, "", "", false],
			CJHouse: [toVector3(2496.65, -1696.55, 1014.74), 3, false, "", "", false],
			MaddDoggMansion: [toVector3(1299.14, -794.77, 1084.00), 5, false, "", "", false],
			MotelRoom2: [toVector3(2262.83, -1137.71, 1050.63), 10, false, "", "", false],
			SafeHouse1: [toVector3(2365.42, -1131.85, 1050.88), 8, false, "", "", false],
			SafeHouse2: [toVector3(2324.33, -1144.79, 1050.71), 12, false, "", "", false],
			ZeroStore: [toVector3(-2240.00, 131.00, 1035.40), 6, false, "", "", false],
			Brothel1: [toVector3(940.65, -18.48, 1000.93), 3, false, "", "", false],
			Brothel2: [toVector3(967.53, -53.02, 1001.12), 3, false, "", "", false],
			Brothel3: [toVector3(744.27, 1437.25, 1102.70), 6, false, "", "", false],
			ProlapsStore: [toVector3(207.35, -138.00, 1003.31), 3, false, "", "", false],
			VictimStore: [toVector3(221.33, -6.61, 1005.19), 5, false, "", "", false],
			SuburbanStore: [toVector3(203.81, -46.53, 1001.80), 1, false, "", "", false],
			SexShop: [toVector3(-106.72, -19.64, 1000.71), 3, false, "", "", false],
			BincoStore: [toVector3(207.54, -109.00, 1005.13), 15, false, "", "", false],
			Wardrobe: [toVector3(255.71, -41.13, 1002.02), 14, false, "", "", false],
			CityHall: [toVector3(389.538, 173.652, 1008.38), 3, false, "", "", false],
			GantonGym: [toVector3(772.11, -3.89, 1000.72), 5, false, "", "", false],
			KungFuGym: [toVector3(774.21, -48.92, 1000.58), 6, false, "", "", false],
			LVGym: [toVector3(773.57, -77.09, 1000.65), 7, false, "", "", false],
			InsuranceCompany: [toVector3(-2029.76, -119.624, 1035.17), 1, false, "", "", false],
			StripClub1: [toVector3(1204.80, -11.58, 1000.92), 2, false, "", "", false],
			StripClub1Private: [toVector3(1204.80, 13.89, 1000.92), 2, false, "", "", false],
			NightClub: [toVector3(493.39, -22.72, 1000.67), 17, false, "", "", false],
			Warehouse1: [toVector3(1412.63, -1.78, 1000.92), 1, false, "", "", false],
			Warehouse2: [toVector3(1302.51, -1.78, 1001.02), 18, false, "", "", false],
			Warehouse3: [toVector3(76.63, -301.15, 1.57), 0, false, "", "", false],
			Warehouse4: [toVector3(1059.89, 2081.68, 10.82), 0, false, "", "", false],
			BikeSchool: [toVector3(1494.32, 1304.94, 1093.28), 3, false, "", "", false],
			Bar1: [toVector3(501.98, -69.15, 998.75), 11, false, "", "", false],
			Diner1: [toVector3(459.58, -88.60, 999.55), 4, false, "", "", false],
			//Diner2: [toVector3(454.97, -110.10, 1000.07), 4, false, "", "", false],
			//Diner3: [toVector3(435.27, -80.95, 999.55), 5, false, "", "", false],
			SmallPoliceStation: [toVector3(322.19, 302.49, 999.14), 5, false, "", "", false],
			Cinema: [toVector3(2179.95, -1009.75, 1021.68), 0, true, "", "", false],
			Courthouse: [toVector3(1219.51, -1792.69, 2431.34), 0, true, "", "", false],
		},

		[V_GAME_GTA_IV]: { // GTA IV
			Office2: [toVector3(-1153.30, 417.37, 5.578), 0, false, "", "", false],
			House1: [toVector3(-426.16, 1466.52, 38.971), 0, false, "", "", false],
			House2: [toVector3(-969.77, 883.27, 18.817), 0, false, "", "", false],
			House3: [toVector3(95.75, 851.68, 45.051), 0, false, "", "", false],
			House4: [toVector3(603.04, 1404.06, 17.479), 0, false, "", "", false],
			House5: [toVector3(892.56, -502.13, 19.407), 0, false, "", "", false],
			House6: [toVector3(-524.09, 830.54, 23.627), 0, false, "", "", false],
			House7: [toVector3(806.36, 146.68, 29.243), 0, false, "", "", false],
			House8: [toVector3(356.91, 1511.28, 21.432), 0, false, "", "", false],
			House9: [toVector3(1319.40, -847.02, 8.872), 0, false, "", "", false],
			House10: [toVector3(1331.40, 126.60, 36.558), 0, false, "", "", false],
			House11: [toVector3(1387.81, 622.66, 35.857), 0, false, "", "", false],
			House12: [toVector3(932.74, -189.29, 35.143), 0, false, "", "", false],
			House13: [toVector3(-1397.85, 1473.89, 26.447), 0, false, "", "", false],
			House14: [toVector3(806.36, 146.68, 29.243), 0, false, "", "", false],
			House15: [toVector3(-526.49, 829.41, 23.627), 0, false, "", "", false],
			Gym: [toVector3(403.31, 1480.32, 11.834), 0, false, "", "", false],
			PoliceStation: [toVector3(-406.67, 284.59, 13.68), 0, false, "copshop", "", false],
			FancyRestaurant: [toVector3(-118.24, -259.06, 12.654), 0, false, "", "", false],
			Basement: [toVector3(1304.38, -856.66, 5.490), 0, false, "", "", false],
			Office1: [toVector3(-409.31, 285.49, 18.592), 0, false, "", "", false],
			Office2: [toVector3(-1153.30, 417.37, 5.578), 0, false, "", "", false],
			Office3: [toVector3(817.64, -259.77, 15.343), 0, false, "", "", false],
			Office4: [toVector3(-86.35, 56.70, 75.953), 0, false, "", "", false],
			HospitalRoom: [toVector3(1240.00, 192.44, 33.553), 0, false, "", "", false],
			Church: [toVector3(-286.72, -282.36, 15.632), 0, false, "", "", false],
			Prison: [toVector3(-1082.69, -364.05, 7.404), 0, false, "", "", false],
			Ship: [toVector3(-336.53, -1494.56, 9.945), 0, false, "", "", false],
		},
		[V_GAME_GTA_IV_EFLC]: { // GTA IV EFLC
		},
		[V_GAME_MAFIA_ONE]: { // Mafia 1
			SalieriBar: [toVector3(-1774.53, -5.56, 6.52), 0, false, "MISE04-SALIERY", "MISE11-SALIERY", false],
			OakHillMansion: [toVector3(43.55, -12.92, 99.49), 0, false, "MISE11-VILA", "", true],
			Country: [toVector3(31.51, 17.37, 990.85), 0, false, "FREEKRAJINA", "FREEKRAJINANOC", true],
			Bank: [toVector3(1.43, 0.03, -6.17), 0, false, "MISE19-BANKA", "", false],
			CorleoneHotel: [toVector3(-549.61, 4.31, -441.92), 0, false, "MISE08-HOTEL", "", false],
			Church: [toVector3(0.02, 15.56, -20.91), 0, false, "MISE08-KOSTEL", "", false],
	...
	maximumFineAmount: {
		...
		[V_GAME_GTA_SA]: 1000,
		[V_GAME_GTA_III]: 1000,
		[V_GAME_MAFIA_ONE]: 100,
	},
	maximumClipAmmo: {
		[V_GAME_MAFIA_ONE]: {
			6: 6, // Colt Detective Special
			7: 6, // S&W Model 27 Magnum
			8: 6, // S&W Model 10 M&P
			9: 7, // Colt 1911
			10: 50, // Thompson 1928
			11: 8, // Pump-action Shotgun
			13: 5, // US Rifle, M1903 Springfield
			14: 5, // Mosin-Nagant 1891/30
		}
	},
	vehicleColours: {
		[V_GAME_GTA_III]: [
		...
		[V_GAME_GTA_IV]: [
			...
			[[37, 37, 39], [255, 255, 255], 1],
			[[101, 106, 121], [255, 255, 255], 2],
			[[88, 89, 90], [255, 255, 255], 3],
			[[156, 161, 163], [255, 255, 255], 4],
			[[150, 145, 140], [255, 255, 255], 5],
			[[81, 84, 89], [255, 255, 255], 6],
			[[63, 62, 69], [255, 255, 255], 7],
			[[165, 169, 167], [255, 255, 255], 8],
			[[151, 149, 146], [255, 255, 255], 9],
			[[118, 123, 124], [255, 255, 255], 10],
			[[90, 87, 82], [255, 255, 255], 11],
			[[173, 176, 176], [255, 255, 255], 12],
			[[132, 137, 136], [255, 255, 255], 13],
			[[148, 157, 159], [255, 255, 255], 14],
			[[164, 167, 165], [255, 255, 255], 15],
			[[88, 88, 83], [255, 255, 255], 16],
			[[164, 160, 150], [255, 255, 255], 17],
			[[175, 177, 177], [255, 255, 255], 18],
			[[109, 108, 110], [255, 255, 255], 19],
			[[100, 104, 106], [255, 255, 255], 20],
			[[82, 86, 97], [255, 255, 255], 21],
			[[140, 146, 154], [255, 255, 255], 22],
			[[91, 93, 94], [255, 255, 255], 23],
			[[189, 190, 198], [0, 0, 0], 24],
			[[182, 182, 182], [0, 0, 0], 25],
			[[100, 100, 100], [255, 255, 255], 26],
			[[226, 6, 6], [255, 255, 255], 27],
			[[150, 8, 0], [255, 255, 255], 28],
			[[107, 0, 0], [255, 255, 255], 29],
			[[97, 16, 9], [255, 255, 255], 30],
			[[74, 10, 10], [255, 255, 255], 31],
			[[115, 11, 11], [255, 255, 255], 32],
			[[87, 7, 7], [255, 255, 255], 33],
			[[38, 3, 6], [255, 255, 255], 34],
			[[158, 0, 0], [255, 255, 255], 35],
			[[20, 0, 2], [255, 255, 255], 36],
			[[15, 4, 4], [255, 255, 255], 37],
			[[15, 8, 10], [255, 255, 255], 38],
			[[57, 25, 29], [255, 255, 255], 39],
			[[85, 39, 37], [255, 255, 255], 40],
			[[76, 41, 41], [255, 255, 255], 41],
			[[116, 29, 40], [255, 255, 255], 42],
			[[109, 40, 55], [255, 255, 255], 43],
			[[115, 10, 39], [255, 255, 255], 44],
			[[100, 13, 27], [255, 255, 255], 45],
			[[98, 11, 28], [255, 255, 255], 46],
			[[115, 24, 39], [255, 255, 255], 47],
			[[171, 152, 143], [0, 0, 0], 48],
			[[32, 32, 44], [255, 255, 255], 49],
			[[68, 98, 79], [255, 255, 255], 50],
			[[46, 91, 32], [255, 255, 255], 51],
			[[30, 46, 50], [255, 255, 255], 52],
			[[48, 79, 69], [255, 255, 255], 53],
			[[77, 98, 104], [255, 255, 255], 54],
			[[94, 112, 114], [255, 255, 255], 55],
			[[25, 56, 38], [255, 255, 255], 56],
			[[45, 58, 53], [255, 255, 255], 57],
			[[51, 95, 63], [255, 255, 255], 58],
			[[71, 120, 60], [255, 255, 255], 59],
			[[147, 163, 150], [255, 255, 255], 60],
			[[154, 167, 144], [255, 255, 255], 61],
			[[38, 55, 57], [255, 255, 255], 62],
			[[76, 117, 183], [255, 255, 255], 63],
			[[70, 89, 122], [255, 255, 255], 64],
			[[93, 126, 141], [255, 255, 255], 65],
			[[59, 78, 120], [255, 255, 255], 66],
			[[61, 74, 104], [255, 255, 255], 67],
			[[109, 122, 136], [255, 255, 255], 68],
			[[22, 34, 72], [255, 255, 255], 69],
			[[39, 47, 75], [255, 255, 255], 70],
			[[78, 104, 129], [255, 255, 255], 71],
			[[106, 122, 140], [255, 255, 255], 72],
			[[111, 130, 151], [255, 255, 255], 73],
			[[14, 49, 109], [255, 255, 255], 74],
			[[57, 90, 131], [255, 255, 255], 75],
			[[32, 75, 107], [255, 255, 255], 76],
			[[43, 62, 87], [255, 255, 255], 77],
			[[54, 65, 85], [255, 255, 255], 78],
			[[108, 132, 149], [255, 255, 255], 79],
			[[77, 93, 96], [255, 255, 255], 80],
			[[64, 108, 143], [255, 255, 255], 81],
			[[19, 69, 115], [255, 255, 255], 82],
			[[16, 80, 130], [255, 255, 255], 83],
			[[56, 86, 148], [255, 255, 255], 84],
			[[0, 28, 50], [255, 255, 255], 85],
			[[89, 110, 135], [255, 255, 255], 86],
			[[34, 52, 87], [255, 255, 255], 87],
			[[32, 32, 44], [255, 255, 255], 88],
			[[245, 137, 15], [255, 255, 255], 89],
			[[145, 115, 71], [255, 255, 255], 90],
			[[142, 140, 70], [255, 255, 255], 91],
			[[170, 173, 142], [255, 255, 255], 92],
			[[174, 155, 127], [255, 255, 255], 93],
			[[150, 129, 108], [255, 255, 255], 94],
			[[122, 117, 96], [255, 255, 255], 95],
			[[157, 152, 114], [255, 255, 255], 96],
			[[152, 149, 134], [255, 255, 255], 97],
			[[156, 141, 113], [255, 255, 255], 98],
			[[105, 30, 59], [255, 255, 255], 99],
			[[114, 42, 63], [255, 255, 255], 100],
			[[124, 27, 68], [255, 255, 255], 101],
			[[34, 25, 24], [255, 255, 255], 102],
			[[127, 105, 86], [255, 255, 255], 103],
			[[71, 53, 50], [255, 255, 255], 104],
			[[105, 88, 83], [255, 255, 255], 105],
			[[98, 68, 40], [255, 255, 255], 106],
			[[125, 98, 86], [255, 255, 255], 107],
			[[170, 157, 132], [255, 255, 255], 108],
			[[123, 113, 94], [255, 255, 255], 109],
			[[171, 146, 118], [255, 255, 255], 110],
			[[99, 92, 90], [255, 255, 255], 111],
			[[201, 201, 201], [0, 0, 0], 112],
			[[214, 218, 214], [0, 0, 0], 113],
			[[159, 157, 148], [255, 255, 255], 114],
			[[147, 163, 150], [255, 255, 255], 115],
			[[156, 156, 152], [255, 255, 255], 116],
			[[167, 162, 143], [255, 255, 255], 117],
			[[15, 106, 137], [255, 255, 255], 118],
			[[161, 153, 131], [255, 255, 255], 119],
			[[163, 173, 198], [255, 255, 255], 120],
			[[155, 139, 128], [255, 255, 255], 121],
			[[132, 148, 171], [255, 255, 255], 122],
			[[158, 164, 171], [255, 255, 255], 123],
			[[134, 68, 110], [255, 255, 255], 124],
			[[226, 6, 6], [255, 255, 255], 125],
			[[71, 120, 60], [255, 255, 255], 126],
			[[215, 142, 16], [255, 255, 255], 127],
			[[42, 119, 161], [255, 255, 255], 128],
			[[66, 31, 33], [255, 255, 255], 129],
			[[111, 103, 95], [255, 255, 255], 130],
			[[252, 38, 0], [255, 255, 255], 131],
			[[252, 109, 0], [255, 255, 255], 132],
			[[255, 255, 255], [0, 0, 0], 133],
			[[245, 180, 0], [255, 255, 255], 134],
			[[5, 5, 5], [255, 255, 255], 135],
			[[189, 149, 75], [255, 255, 255], 136],
		]
	},
};
